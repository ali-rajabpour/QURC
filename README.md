...
> **QUR Coin (QURC)** is an Islamic-values-inspired token built on the Tron blockchain (TRC20). This repository contains the full infrastructure stack used to run the QUR Coin web presence, including a countdown landing page, a Telegram MiniApp for community engagement, and a WordPress site with SSL configuration.
...
| **Website**    | [qurancoin.io](https://qurancoin.io)   |
